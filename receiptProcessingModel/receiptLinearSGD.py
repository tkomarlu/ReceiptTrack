...
#using Linear Stochastic Gradient Descent classifier
model = linear_model.SGDClassifier(max_iter=1000, tol=1e-2).fit(X_train, y_train)
...
#LinearSGD accuracy = 0.9539, model training time was 80.176 seconds
