...
#can choose between either Multinomial Naive Bayes or Bernoulli Naive Bayes classifiers, uncomment the one to use
#model = MultinomialNB(alpha=.01).fit(X_train, y_train)
model = BernoulliNB(alpha=.01).fit(X_train, y_train)
...
#MultinomialNB accuracy = 0.9705, model training time was .2728 seconds
#BernoulliNB accuracy = 0.9727, model training time was .3055 seconds
