...
#TFIDF Vectorizer executes both Count Vectorizer and TFIDF Transformer in one line
...
#RF accuracy = 0.9656, model training time was 172.26 seconds

#print(model.predict(tfidf_vect.transform(["adidas women shoes"])))
