...
##ENCOUNTER MEMORY ISSUES WHILE RUNNING, PROBABLY NEED MORE RAM, NEED TO RUN ON LARGER COMPUTER
...
#GaussianNB accuracy = 0.9705, model training time was .2728 seconds
